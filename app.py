...
SAMPLE_TEXTS = {
    "Technology & AI": """Artificial Intelligence has revolutionized the way we work and live. Machine learning algorithms 
    are now being used to solve complex problems across various industries, from healthcare to finance. Deep learning models, 
    particularly transformers, have achieved state-of-the-art results in natural language processing tasks. The development of 
    large language models has opened new possibilities for AI applications. However, challenges remain in terms of explainability, 
    bias, and computational efficiency. Research continues to push the boundaries of what AI can achieve while addressing these concerns.""",
    
    "Climate Change": """Climate change represents one of the most pressing challenges of our time. Rising global temperatures 
    are causing severe weather events, melting ice caps, and threatening ecosystems worldwide. The primary cause is greenhouse gas 
    emissions from human activities, particularly fossil fuel consumption. Scientists agree that urgent action is needed to reduce 
    emissions and transition to renewable energy sources. Many countries have committed to net-zero targets, investing in solar and 
    wind power. Individual actions, such as reducing consumption and supporting sustainable practices, also play a crucial role in 
    addressing this global crisis.""",
    
    "Space Exploration": """Space exploration has captivated human imagination for decades. From the Apollo moon missions to 
    modern rovers on Mars, we've made remarkable progress in understanding the universe. Today, private companies like SpaceX are 
    lowering the cost of space travel and making it more accessible. The search for extraterrestrial life continues through missions 
    like those investigating Europa and Enceladus. Advanced telescopes like the James Webb Space Telescope have revealed unprecedented 
    details about distant galaxies and the early universe. These discoveries not only satisfy our curiosity but also provide insights 
    into fundamental questions about our place in the cosmos.""",
    
    "Health & Wellness": """Maintaining good health requires a balanced approach combining diet, exercise, and mental wellness. 
    Regular physical activity strengthens the body and reduces the risk of chronic diseases. A nutritious diet rich in fruits, 
    vegetables, and whole grains provides essential nutrients and energy. Mental health is equally important, and practices like 
    meditation, yoga, and social connections contribute to overall well-being. Sleep quality plays a vital role in recovery and 
    cognitive function. Modern technology like fitness trackers and health apps can help monitor and improve personal wellness. 
    Consulting healthcare professionals ensures proper guidance for maintaining and improving health throughout life.""",
}
